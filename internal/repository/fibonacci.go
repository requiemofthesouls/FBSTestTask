...
func (r *FibonacciRepository) GetCachedFibSequence(ctx context.Context, end int) ([]int, error) {
	var result []int
...
func (r *FibonacciRepository) SetFibSequence(ctx context.Context, fibSequence []int, end int) error {
	toSet := cache.Item{
		Ctx:   ctx,
